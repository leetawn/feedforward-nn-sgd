...
- **Drawing Area and MNIST Alignment:** The network is trained on the standard MNIST dataset. Because of this, accuracy depends heavily on how closely your hand-drawn digits match the style, thickness, and centering of the original training images. It can achieve good results on the actual MNIST dataset itself, I just wanted it to be interactive or something, hence the drawing area.
